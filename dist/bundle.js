...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(/*! ./components/App */ 159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Header = __webpack_require__(/*! ./Header */ 160);
	
	var _Header2 = _interopRequireDefault(_Header);
	
	var _Table = __webpack_require__(/*! ./Table */ 161);
	
	var _Table2 = _interopRequireDefault(_Table);
	
	var _Tabs = __webpack_require__(/*! ./Tabs */ 163);
	
	var _Tabs2 = _interopRequireDefault(_Tabs);
	
	var _jsonDataJson = __webpack_require__(/*! json!../../../data.json */ 165);
	
	var _jsonDataJson2 = _interopRequireDefault(_jsonDataJson);
	...
	var App = (function (_React$Component) {
	  ...
	  function App() {
	    ...
	    this.state = {
	      "entries": _jsonDataJson2["default"].entries,
	      "filteredEntries": _jsonDataJson2["default"].entries
	    };
	  }
	
	  _createClass(App, [{
	    key: "filterDay",
	    value: function filterDay(day) {
	      if (day === "All") {
	        this.setState({
	          "filteredEntries": this.state.entries
	        });
	      } else {
	        var filtered = this.state.entries.filter(function (entry) {
	          return entry.when.day === day;
	        });
	        this.setState({
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(_Table2["default"], { filteredEntries: this.state.filteredEntries }),
	        _react2["default"].createElement(_Tabs2["default"], { filterDay: this.filterDay.bind(this) })
	      );
	    }
	  }]);
	...
	var Header = (function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'h1',
	        { style: { color: '#33CC00', textAlign: 'center' } },
	        'Meditation Around San Francisco'
	      );
	    }
	  }]);
...
/* 161 */
/*!******************************************!*\
  !*** ./src/scripts/components/Table.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Entry = __webpack_require__(/*! ./Entry */ 162);
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "tbody",
	          null,
	          this.props.filteredEntries.map(function (entry, i) {
	            return _react2["default"].createElement(_Entry2["default"], _extends({}, entry, { key: i }));
	          })
	        )
	      );
	    }
...
/* 162 */
/*!******************************************!*\
  !*** ./src/scripts/components/Entry.jsx ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Entry = (function (_React$Component) {
	  ...
	  _createClass(Entry, [{
	    key: "render",
	    value: function render() {
	      var _extends2 = _extends({}, this.props);
	
	      var location = _extends2.location;
	      var address = _extends2.address;
	      var leader = _extends2.leader;
	      var when = _extends2.when;
...
/* 163 */
/*!*****************************************!*\
  !*** ./src/scripts/components/Tabs.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tab = __webpack_require__(/*! ./Tab */ 164);
	
	var _Tab2 = _interopRequireDefault(_Tab);
	
	var days = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday", "All"];
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        days.map(function (day, i) {
	          return _react2["default"].createElement(_Tab2["default"], { day: day, key: i, filterDay: _this.props.filterDay });
	        })
	      );
	    }
	  }]);
...
/* 164 */
/*!****************************************!*\
  !*** ./src/scripts/components/Tab.jsx ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Tab, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        "span",
	        { onClick: function () {
	            _this.props.filterDay(_this.props.day);
	          } },
	        this.props.day + " "
	      );
	    }
...
/***/ function(module, exports) {
	...
	module.exports = {
		"entries": [
			{
				"location": "Zen Buddhist Center",
				"address": "1588 15th Street Apt 402, San Francisco, CA 94103",
				"when": {
					"day": "Thursday",
					"time": "19:30"
				},
				"description": "a meditation",
				"leader": "Bren"
			},
			{
				"location": "Transcendental Meditation Center",
				"address": "1589 15th Street Apt 411, San Francisco, CA 94103",
				"when": {
					"day": "Friday",
					"time": "19:30"
				},
			...
			{
				"location": "Vipassana Buddhist Center",
				"address": "1530 15th Street Apt 410, San Francisco, CA 94103",
				"when": {
					"day": "Wednesday",
					"time": "15:30"
				},
			...
			{
				"location": "Stress Free Center",
				"address": "1587 15th Street Apt 407, San Francisco, CA 94103",
				"when": {
					"day": "Tuesday",
					"time": "19:30"
				},
			...
			{
				"location": "Meditation Express Center",
				"address": "1587 15th Street Apt 403, San Francisco, CA 94111",
				"when": {
					"day": "Monday",
					"time": "19:30"
				},
